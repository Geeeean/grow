...
declare module '@tanstack/react-router' {
    interface FileRoutesByPath {
        ...
        '/(app)/_layout/vineyards/$vineyardId': {
            id: '/_layout/vineyards/$vineyardId';
            path: '/vineyards/$vineyardId';
...
export interface FileRoutesById {
    ...
    '/_layout/vineyards/$vineyardId': typeof appLayoutVineyardsVineyardIdRoute;
}
